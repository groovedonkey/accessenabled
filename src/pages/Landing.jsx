...
const PLANS = [
  {
    ...
    blurb:
      "A no-cost conversation plus an initial electronic scan of your website to show where you stand today.",
    features: [
  ...
  },
  {
    ...
    cta: "Get the DIY kit",
    blurb:
      "The complete AccessEnabled ADA checklist so your team can run an unofficial, self-guided audit at your own pace.",
    features: [
  ...
  },
  {
    ...
    cta: "Request a quote",
    blurb:
      "A complete, expert-led audit ending in the “AccessEnabled Certified ADA Accessible” badge for your website.",
    features: [
    ...
    <div className="lp">
      ...
      <section className="lp-hero" id="top">
        ...
        <div className="lp-hero-inner">
          <span className="lp-eyebrow">
            <Sparkles size={15} /> ADA &amp; WCAG Accessibility Consulting
          </span>
          <h1>
            Make your website <span className="lp-accent">accessible</span> —
            <br />
            and provably compliant.
          </h1>
          <p className="lp-sub">
            AccessEnabled helps businesses meet ADA Title III and WCAG
            standards, reduce legal risk, and welcome every visitor. Start with
            a free scan of your site today.
          </p>
          <div className="lp-hero-actions">
            <button
              className="lp-btn lp-btn-primary"
              onClick={() => scrollToForm("free-consult")}
            >
          ...
          <div className="lp-hero-badges">
            <span>
              <Check size={15} /> WCAG 2.1 / 2.2
            </span>
            <span>
              <Check size={15} /> ADA Title III
            </span>
            <span>
              <Check size={15} /> Section 508
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="lp-why" id="why">
        <div className="lp-section-head">
          ...
          <p>
            Inaccessible sites lose customers and invite lawsuits. We help you
            fix both.
          </p>
        </div>
        <div className="lp-why-grid">
          <div className="lp-why-card">
            ...
            <p>
              Thousands of ADA web lawsuits are filed every year. A documented
              audit shows good-faith compliance.
            </p>
          </div>
          <div className="lp-why-card">
            <Gauge size={22} />
            ...
            <p>
              1 in 4 U.S. adults lives with a disability. Accessible design
              opens your business to all of them.
            </p>
          </div>
          <div className="lp-why-card">
            <FileText size={22} />
            <h3>Better SEO &amp; UX</h3>
            <p>
              The same fixes that help screen readers also improve search
              rankings and overall usability.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="lp-pricing" id="pricing">
        <div className="lp-section-head" id="services">
          ...
          <p>
            From a free starting scan to a fully certified audit — pick what
            fits your business.
          </p>
        </div>
        <div className="lp-plans">
          {PLANS.map((plan) => {
            ...
            return (
              ...
              >
                {plan.tagline && (
                  <span className="lp-plan-tag">{plan.tagline}</span>
                )}
                ...
                <div className="lp-plan-price">
                  {plan.oldPrice && (
                    <span className="lp-price-old">{plan.oldPrice}</span>
                  )}
        ...
        <p className="lp-pricing-note">
          <BadgeCheck size={16} /> Full audit pricing is tailored to the size
          and complexity of your website, so you only pay for what your project
          actually needs.
        </p>
      </section>
      ...
      <section className="lp-contact" id="lp-contact">
        <div className="lp-contact-inner">
          <div className="lp-contact-copy">
            ...
            <p>
              Tell us about your site and we’ll run an initial electronic scan,
              then follow up with your results and the best next step. No cost,
              no obligation.
            </p>
            <ul className="lp-contact-points">
              <li>
                <Check size={16} /> Initial electronic scan included
              </li>
              <li>
                <Check size={16} /> Response within one business day
              </li>
              <li>
                <Check size={16} /> Honest, jargon-free guidance
              </li>
            </ul>
          </div>
          ...
          <form className="lp-form" onSubmit={handleSubmit}>
            {status === "done" ? (
              <div className="lp-form-success">
                ...
                <p>
                  Thanks! We’ll review your site and get back to you within one
                  business day.
                </p>
                <button
                  type="button"
              ...
              <>
                ...
                <p className="lp-form-fine">
                  We’ll only use your details to follow up about your
                  accessibility audit.
                </p>
              </>
            )}
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          ...
          <span className="lp-footer-copy">
            © {new Date().getFullYear()} AccessEnabled. All rights reserved.
          </span>
        </div>
      </footer>
    </div>
