...
export const REMEDIATION = {
  "1.1.1": {
    summary:
      "Every meaningful image needs a text alternative; decorative images must be hidden from assistive tech.",
    steps: [
    ...
    example:
      '<img src="team.jpg" alt="The AccessEnabled team at the 2024 conference">\n<img src="divider.png" alt="">',
    reference: `${U}/non-text-content.html`,
  },
  "1.2.1": {
    summary:
      "Prerecorded audio-only and video-only content needs an equivalent text or audio alternative.",
    steps: [
  ...
  "1.2.2": {
    summary:
      "Prerecorded video with sound must have synchronized, accurate captions.",
    steps: [
  ...
  "1.2.3": {
    summary:
      "Provide an audio description or full text alternative for prerecorded video.",
    steps: [
  ...
  "1.3.1": {
    summary:
      "Use semantic HTML so structure and relationships are programmatically available.",
    steps: [
  ...
  "1.3.5": {
    summary:
      "Use HTML autocomplete tokens on inputs that collect known user data.",
    steps: [
  ...
  "1.4.10": {
    summary:
      "Content must reflow to a 320px-wide viewport without two-dimensional scrolling.",
    steps: [
  ...
  "2.5.3": {
    summary:
      "An element's accessible name must include its visible label text.",
    steps: [
    ...
    example:
      '<!-- Visible text "Search" must be in the name -->\n<button aria-label="Search">Search</button>',
  ...
  "3.2.3": {
    summary:
      "Repeated navigation must stay in a consistent order across pages.",
    steps: [
  ...
  "3.3.7": {
    summary:
      "Avoid forcing users to re-enter information they already provided.",
    steps: [
  ...
  "4.1.2": {
    summary:
      "Custom components must expose name, role, and value to assistive tech.",
    steps: [
  ...
  "4.1.3": {
    ...
    example:
      '<div role="status" aria-live="polite">Your changes were saved.</div>',
